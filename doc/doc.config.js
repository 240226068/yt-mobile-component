...
module.exports = {
  sections: [
    ...
    },
    {
      name: 'btnGroup',
      path: '/btnGroup',
      options: ['package/btnGroup/index.vue'],
      contents: ['package/btnGroup/README.md'],
      examples: [
        { text: 'demo源码', path: 'src/example/btnGroup.vue' }
      ]
    },
    {
      name: 'cell',
    ...
    },
    {
      name: 'cellCall',
      path: '/cellCall',
      options: ['package/_call/index.vue'],
      contents: ['package/_call/README.md'],
      examples: [
        { text: 'demo源码', path: 'src/example/cellCall.vue' }
      ]
    },
    {
      name: 'cellTime',
      path: '/cellTime',
      options: ['package/_time/index.vue'],
      contents: ['package/_time/README.md'],
      examples: [
        { text: 'demo源码', path: 'src/example/cellTime.vue' }
      ]
    },
    {
      name: 'checkBox',
