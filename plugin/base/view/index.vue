<template>
  <div class="yt-view" @click="handlerClick" @mousedown="handleMouseDown" @mouseup="end()" @mouseleave="end()"
       @touchstart="handleTouchStart" @touchend="end()" @touchcancel="end()">
    <div v-show="ripple" class="yt-view-ripple-wrapper" :class="rippleWrapperClass" ref="holder">
      <circle-ripple :key="item.key" :color="item.color" :opacity="item.opacity" :merge-style="item.style"
