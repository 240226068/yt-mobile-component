<template>
  <div class="yt-progress">
    ...
    <div class="yt-progress-line" v-else-if="type === 'line'">
      <div class="yt-progress-line-wrapper">
        <div class="yt-progress-line-cur" :style="lineCurStyle"></div>
        <div class="yt-progress-line-trail" :style="lineTrailStyle"></div>
      </div>
      <div v-if="$slots.default" class="yt-progress-line-content" :class="`is-${lineContentPos}`">
        <slot :color="currentColor"></slot>
      </div>
    </div>
  </div>
